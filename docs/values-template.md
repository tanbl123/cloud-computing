# Values to record as you build

Copy this to `evidence/values.md` in your own working copy and fill it in as you go. These are the
things that are not screenshots but that the report needs, and that are irritating to hunt down
again later.
